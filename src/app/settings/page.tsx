      ...
      <PageContainer compact>
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div className="glass-panel rounded-xl p-5">
            <Settings className="mb-3 size-5 text-[var(--goal-mint)]" />
            <p className="font-heading text-xl font-black text-white">Data mode</p>
            <p className="mt-2 text-sm text-slate-400">{firebaseReady && !isDemoMode ? 'Firebase ready' : 'Demo/mock mode'}</p>
          </div>
          <div className="glass-panel rounded-xl p-5">
            <p className="font-heading text-xl font-black text-white">Payments</p>
