  ...
  return (
    <main className="flex min-h-[80vh] items-center justify-center p-4">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[#0A0D14] p-8 shadow-2xl">
        <h1 className="mb-2 text-center font-heading text-3xl font-black text-white">Login</h1>
        ...
        <div className="flex flex-col gap-4">
          ...
          <button className="w-full rounded-xl bg-[var(--goal-emerald)] py-3 font-bold text-[#05070A] transition-colors hover:bg-[#00E67A]">Login</button>
        </div>
      </div>
    </main>
  );
