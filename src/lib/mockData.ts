...
export const mockLeagues: League[] = [
  { id: 'l1', name: 'Kampala Grassroots Football League', sport: 'Football', country: 'Uganda', city: 'Kampala', ranking: 1, logoUrl: '/placeholders/football-gradient.svg', verifiedPercentage: 98, completionRate: 95 },
  { id: 'l2', name: 'Uganda Community Basketball League', sport: 'Basketball', country: 'Uganda', city: 'Wakiso', ranking: 2, logoUrl: '/placeholders/basketball-gradient.svg', verifiedPercentage: 95, completionRate: 90 },
  { id: 'l3', name: 'Kampala Rugby Sevens League', sport: 'Rugby', country: 'Uganda', city: 'Entebbe', ranking: 3, logoUrl: '/placeholders/rugby-gradient.svg', verifiedPercentage: 100, completionRate: 100 },
];
