      ...
      <div className="rounded-[var(--radius-lg)] border border-border bg-surface-1 bezel-core p-5 transition-colors hover:border-border-strong">
        ...
        <div className="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2 sm:gap-3">
          <div className="flex min-w-0 items-center justify-end gap-2 text-right sm:gap-2.5">
            <span className="min-w-0 truncate text-sm font-semibold text-text-strong">{home?.name ?? 'Home'}</span>
          ...
          <div className="flex min-w-0 items-center gap-2 sm:gap-2.5">
            ...
            <span className="min-w-0 truncate text-sm font-semibold text-text-strong">{away?.name ?? 'Away'}</span>
          </div>
        </div>
